...
This candidate is prepared under the PolyForm Noncommercial License 1.0.0,
subject to final copyright-holder and legal review. It is source available, not
OSI-approved open source. Commercial use requires prior written permission or a
...
Publication requires the full quality, conformance, historical-compatibility,
research, package-build, and clean-install checks, plus copyright-holder and
legal approval of the licensing transition. This draft does not create a tag,
